                    ...
                    <div className="p-2 mt-4 w-full mx-auto xl:p-5 flex justify-center mb-15 md:items-start md:justify-start md:gap-x-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-2 w-8/10 md:max-w-full">
                            {allBikes && allBikes.map((bike) => (
                                    <div key={bike._id} className= "relative rounded-lg bg-white shadow-md border border-gray-200 overflow-hidden">
                                        <div className={`${bike?.isAvailable ? 'hidden' : 'absolute bg-gray-100/50 w-full h-full flex justify-center items-center'}`}>
                                            <h3 className='w-full text-center bg-black/85 text-white p-2 '>Bike is Booked</h3>
                                        </div>
                                        {/* Bike Information */}
                                        <div className="p-4">
